...
module.exports = (er, npm) => {
  ...
  switch (er.code) {
    case 'ERESOLVE':
      ...
      detail.push(['', ''])
      // TODO: npm.logColor is required here because this message gets written to the log
      // this should probably happen elsewhere because it gets colorized before logging
